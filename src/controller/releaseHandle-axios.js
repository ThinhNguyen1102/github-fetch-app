...
const fetchReleaseFromUrl = async (url, page = 1, releaseList = []) => {
  ...
  try {
    ...
    //   page: page,
    // });
    const apiUrl = `https://api.github.com/repos/${owner}/${repo}/releases?per_page=${100}&page=${page}`;
...
const fetchCommitFromRelease = async (release, page = 1, commitList = []) => {
  ...
  try {
    ...
    //   }
    // );
    const apiUrl = `https://api.github.com/repos/${owner}/${repo}/compare/${prevReleaseTagName}...${tagName}?per_page=${100}&page=${page}`;
...
const fetchCommitFirstRelease = async (release) => {
  ...
  try {
    ...
    const apiUrl = `https://api.github.com/repos/${owner}/${repo}/commits/${tagName}`;
